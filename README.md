...
✔ Entities can be manipulated without needing to be part of a Database Context;<br/>
✔ If the database is out of sync with the C# code, the manipulations may still work.<br/>
