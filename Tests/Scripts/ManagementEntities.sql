...
CREATE TABLE TESTTABLECSV_UTF8 (
    OLA__MUNDO_ NVARCHAR2(1000),
    ACUCAR__CAFE_E_CHA NVARCHAR2(1000),
    C___10 NVARCHAR2(1000),
    C__COMO_ESTAS_ NVARCHAR2(1000),
    BONJOUR__CA_VA_ NVARCHAR2(1000),
    C__GUTEN_TAG__WIE_GEHT_S__ NVARCHAR2(1000),
    C_45 NVARCHAR2(1000),
    R__5_00 NVARCHAR2(1000),
    北京 NVARCHAR2(1000),
    你好_ NVARCHAR2(1000)
)

SELECT name FROM v$database; -- 'ORCLCDB'

SELECT * FROM NLS_DATABASE_PARAMETERS WHERE PARAMETER = 'NLS_CHARACTERSET';
-- Charset=AL32UTF8 not support unicode chars
